...
public class DoctorSignupActivity extends TabActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.setNewTab(this, tabHost, "new_doctor_info_tab",
				R.string.new_doctor_info_tab, android.R.drawable.ic_menu_edit,
				new Intent(this, DoctorBioInfoActivity.class));
		this.setNewTab(this, tabHost, "doctors_list_tab",
				R.string.doctors_list_tab, android.R.drawable.ic_menu_agenda,
				new Intent(this, DoctorsListActivity.class));
	}

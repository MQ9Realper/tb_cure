	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == CAPTURE_VIDEO_ACTIVITY_REQUEST_CODE) {
			...
			if (resultCode == RESULT_OK) {
				...
				output.setText("Video File : " + fileUri.getPath().toString());

				// Video captured and saved to fileUri specified in the Intent
				Toast.makeText(this, "Video saved to:" + fileUri.getPath().toString(),
						Toast.LENGTH_LONG).show();
				
				//////// Save to database here ///////
				database_adapter.addAdherenceReport(fileUri.getPath().toString(), DateFormat.getDateInstance().format(new Date()));

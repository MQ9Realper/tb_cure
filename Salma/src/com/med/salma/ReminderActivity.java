...
public class ReminderActivity extends TabActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.setNewTab(this, tabHost, "new_reminder_tab",
				R.string.new_reminder_tab, android.R.drawable.ic_menu_edit,
				new Intent(this, NewReminderActivity.class));
		this.setNewTab(this, tabHost, "reminder_list_tab",
				R.string.reminder_list_tab, android.R.drawable.ic_menu_agenda,
				new Intent(this, ReminderListActivity.class));

		this.setNewTab(this, tabHost, "refills", R.string.medicine_refills_tab,
				R.drawable.ic_action_pill, new Intent(this,
						MedicineRefillsActivity.class));
	}

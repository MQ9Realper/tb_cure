...
public class NewReminderActivity extends Activity {
	...
	public Calendar reminderCalendar;
		...
		TimePickerDialog timePicker = new TimePickerDialog(this,
				new TimePickerDialog.OnTimeSetListener() {
					...
					public void onTimeSet(TimePicker view, int hourOfDay,
							int minute) {
						// TODO Auto-generated method stub
						reminderCalendar.setTimeInMillis(java.lang.System
								.currentTimeMillis());
						reminderCalendar.set(Calendar.HOUR_OF_DAY, hourOfDay);
						reminderCalendar.set(Calendar.MINUTE, minute);
						updateTimeText();
                   
						///////////////// START OF SETTING ALARM ////////////////////////////////////////
						// Setting alarm
						...
						alarmMgr.set(AlarmManager.RTC_WAKEUP,
								reminderCalendar.getTimeInMillis(), alarmIntent);
				...
				}, reminderCalendar.get(Calendar.HOUR_OF_DAY), reminderCalendar
